...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ComboBox_2.addItems(["19200", "4800", "9600","38400","57600", "115200"])
        ...
        self.labels[0].move(int(0),int(100))  #CG
        self.labels[0].setText("CG: --")
        self.labels[1].move(int(0),int(160))  #IG
        self.labels[1].setText("IG: --")
        ...
        self.checkboxes[0].setText(f"CG")
        self.checkboxes[1].setText(f"IG")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "HornetPressure"))

        self.checkboxes[0].setText(_translate("MainWindow",f"CG"))
        self.checkboxes[1].setText(_translate("MainWindow",f"IG"))
        self.labels[0].setText(_translate("MainWindow", f"CG: --"))
        self.labels[1].setText(_translate("MainWindow", f"IG: --"))
